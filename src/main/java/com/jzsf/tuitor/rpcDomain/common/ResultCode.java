...
public enum ResultCode implements Serializable {
    ...
    USER_CAN_USED(20005, "账户已注册且可用"),
    USER_INVALID(20005, "无效用户，未激活或未注册"),
    CAN_NOT_REGISTER(20006, "正在尝试没有验证码获取记录的用户注册，无法完成"),

    GET_CAPTCHA_SUCCESS(20018, "获取验证码成功"),
    ...
    MAIL_SEND_FAIL(20025, "获取验证码失败, 当前邮箱无效或已被注册"),
    LOGIN_SUCCESS(20026, "登陆成功！"),
    ...
    REG_DATA_IS_WRONG(50002, "无法返回验证码：注册数据有误，需用户名密码和邮箱"),
